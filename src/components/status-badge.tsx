...
const STATUS_LABELS: Record<string, string> = {
  ...
  ready_to_draft: "Redacción pedida",
...
const STATUS_CLASSNAMES: Record<string, string> = {
  ...
  ready_to_draft: "border-indigo-200 bg-indigo-50 text-indigo-700",
  ...
  researching: "border-violet-200 bg-violet-50 text-violet-700",
  drafting: "border-indigo-200 bg-indigo-50 text-indigo-700",
